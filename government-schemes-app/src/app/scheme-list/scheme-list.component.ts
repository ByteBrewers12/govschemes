    ...
    this.filteredSchemes = this.schemes.filter((scheme) => {
      const matchesProfession =
        this.selectedSearchCriteria === 'profession'
          ? scheme.profession.toLowerCase() === this.professionSearchTerm.toLowerCase()
          : true;
      const matchesAge =
        this.selectedSearchCriteria === 'age' ? scheme.minAge <= this.ageSearchTerm : true;
      const matchesGender =
      ...
      const matchesName =
        this.selectedSearchCriteria === 'name'
          ? scheme.name.toLowerCase().includes(this.nameSearchTerm.toLowerCase())
          : true;
