const schemes = [
  {
    id: 1,
    name: "Kunwar Bai Nu Mameru Yojna",
    description:
      "The scheme provides financial assistance for the marriage of two adult daughters from economically backward classes.",
    profession: "Family",
    minAge: 18,
    imageUrl:
      "https://www.grandforksherald.com/news/local/covid-19-vaccinations-now-available-at-grand-forks-public-health",
    gender: "female",
    benefits: "Financial assistance for marriage expenses",
    applicationProcess: "Apply online through the official portal.",
    requiredDocuments:
      "Daughter's Aadhaar Card, Annual income pattern of bride's father/guardian, Marriage registration certificate, Bank Passbook/ Canceled Check (Girl's Name)",
